...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-dark-card border border-dark-border rounded-lg shadow-lg p-6">
            <h2 class="text-3xl font-bold text-dark-text mb-6">Editar Detalle de Orden</h2>

            <form action="{{ route('order-details.update', $orderDetail->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    <label for="product_id" class="block text-sm font-medium text-dark-text mb-2">Producto:</label>
